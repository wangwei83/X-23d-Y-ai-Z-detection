...
def main():
    # 加载原始点云  /home/wangwei-uestc/cloud_lesson/lesson-one/airplane_0001.txt
    with open('/home/wangwei-uestc/cloud_lesson/lesson-one/'
              'modelnet40_shape_names.txt') as f:
        a = f.readlines()
    for i in a:
        point_cloud_pynt = PyntCloud.from_file(
            '/home/wangwei-uestc/cloud_lesson/lesson-one/'
