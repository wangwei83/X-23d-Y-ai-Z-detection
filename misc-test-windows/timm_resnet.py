...
LastEditTime: 2024-06-02 23:00:12
...
model = timm.create_model('resnetv2_152x2_bit.goog_teacher_in21k_ft_in1k', pretrained=True,
                          pretrained_cfg_overlay=dict(file='/data/wangwei/resnetv2_152x2_bit.bin'))
# model = model.eval()

# weights = torch.load('/data/wangwei/resnetv2_152x2_bit.goog_teacher_in21k_ft_in1k-pytorch_model.bin')
# print(weights.keys())
